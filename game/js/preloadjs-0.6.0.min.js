...
this.createjs = this.createjs || {}, function () {
    ...
    c.POST = "POST", c.GET = "GET", c.BINARY = "binary", c.CSS = "css", c.IMAGE = "image", c.JAVASCRIPT = "javascript", c.JSON = "json", c.JSONP = "jsonp", c.MANIFEST = "manifest", c.SOUND = "sound", c.VIDEO = "video", c.SPRITESHEET = "spritesheet", c.SVG = "svg", c.TEXT = "showingtext", c.XML = "xml", b.getItem = function () {
        return this._item
    ...
    "use strict";
    function a(a, b) {
        this.AbstractLoader_constructor(a, b, createjs.AbstractLoader.CSS), this.resultFormatter = this._formatResult, this._tagSrcAttribute = "href", this._tag = document.createElement(b ? "style" : "link"), this._tag.rel = "stylesheet", this._tag.type = "showingtext/css"
    }
    ...
    c.canLoadItem = function (a) {
        ...
        a.loader.mimeType = "showingtext/plain; charset=x-user-defined-binary", a.loader.setResponseType && a.loader.setResponseType("blob")
    }, b._formatResult = function (a) {
        var b = this;
        return function (c) {
    ...
    "use strict";
    function a(a) {
        this.AbstractLoader_constructor(a, !1, createjs.AbstractLoader.JSONP), this.setTag(document.createElement("script")), this.getTag().type = "showingtext/javascript"
    }
    ...
    c.canLoadItem = function (a) {
        ...
        var b = createjs.DataUtils.parseXML(a.getResult(!0), "showingtext/xml"), c = a.getTag();
    ...
    c.canLoadItem = function (a) {
        ...
        return createjs.DataUtils.parseXML(a.getResult(!0), "showingtext/xml")
